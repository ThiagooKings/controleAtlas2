...
public class JanelaListar implements ActionListener, ListSelectionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (o == btFechar) {
			...
			// atravez da linha pego o produto
				...
				if (JOptionPane.showConfirmDialog(frmListar, "Tem certeza que deseja excluir o Produto?", "Atenção!",
						JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {

					produtoSel = tmProdutos.getProduto(linhaSel);
					JOptionPane.showMessageDialog(frmListar, "Produto excluido com sucesso!", "Sucesso!",
